...
class DinoTests(unittest.TestCase):
    ...
    def test_zip_rejects_wrong_format(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            for mode,size,color,valid in [('L',(1024,1024),8,True),('L',(1024,1024),9,False),('L',(1024,1024),0,False),('RGB',(1024,1024),0,False),('L',(512,512),1,False)]:
