...
class ResumeTest(unittest.TestCase):
    def test_validation_interruption_and_best_selection(self):
        c=read(ROOT/'configs/train.json'); c.update(epochs=2,batch_size=1,accumulation=2,validate_every_epochs=1,train_miou_every_updates=1,checkpoint_every_updates=1)
